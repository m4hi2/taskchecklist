defmodule TaskchecklistWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TaskchecklistWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TaskchecklistWeb.Gettext, "errors", msg, opts)
    end
  end
