...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is ./config/.taskchecklist.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in configDir directory with name ".taskchecklist" (without extension).
